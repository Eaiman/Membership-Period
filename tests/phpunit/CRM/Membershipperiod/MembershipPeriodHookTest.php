 ...
 * @group headless
 */
class CRM_Membershipperiod_MembershipPeriodHookTest extends \PHPUnit_Framework_TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
  ...
  public function testWellFormedUF() {
	...
	function hook_civicrm_tabset($tabsetName, &$tabs, $context) {
